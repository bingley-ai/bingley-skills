...
SKILLS = {
    ...
    # skill (cold-email, company-research, list-builder and the rest) wakes up populated.
    ...
    # company-research: shared by every research surface of company-researcher (its modes'
    # call `--skill company-research`). Read-mostly: the research skills consume identity and
