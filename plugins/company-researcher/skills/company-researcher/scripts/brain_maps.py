...
SKILLS = {
    ...
    # the research skill consumes identity, writes progress flags + working-context notes freely,
    # and writes identity only via the user-confirmed deep capture in SKILL.md (--confirmed),
    # never silently.
    "company-research": {
        "profile": {
            "name": "business.name", "product": "business.product", "audience": "business.audience",
